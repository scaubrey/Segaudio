...
#include "SegaudioFilePreviewComponent.h"
//[/Headers]
...
//    ScopedPointer<AudioThumbnailCache> appThumbCache;
//    ScopedPointer<AudioFormatManager> appFormatManager;
    int sourceSamplesPerThumbnailSample;
    //[/UserVariables]

    //==============================================================================
    ScopedPointer<Slider> thresholdSlider;
    ScopedPointer<Label> thresholdSliderLabel;
    ScopedPointer<ToggleButton> rmsToggle;
    ScopedPointer<TextButton> analyzeButton;
